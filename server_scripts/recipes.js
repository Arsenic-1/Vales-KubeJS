...
function registerRecipes(
  ...
  event.smithing(
    smithingRecipe.output,
    smithingRecipe.template,
    smithingRecipe.itemToUpgrade,
    smithingRecipe.upgradeItem
  );
  event.recipes.create.mechanical_crafting(
    mechanicalCraftingRecipe.output,
    mechanicalCraftingRecipe.shape,
    mechanicalCraftingRecipe.mapping
  );
}

// Recipe definitions
const shapedRecipe = createShapedRecipe(
  MW("diamond_greatsword"),
  ["   ", " d ", "dsd"],
  { d: MC("diamond"), s: MC("stick") }
);
const smithingRecipe = createSmithingRecipe(
  MW("netherite_greatsword"),
  MC("echo_shard"),
  MW("diamond_greatsword"),
  MC("oak_log")
);
const mechanicalCraftingRecipe = createMechanicalCraftingRecipe(
  MC("dirt"),
